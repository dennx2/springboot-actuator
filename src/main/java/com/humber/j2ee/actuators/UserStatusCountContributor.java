...
public class UserStatusCountContributor implements InfoContributor {
	...
	public void contribute(Builder builder) {
		...
		userStatusMap.put("active", database.getUserStatusCountByStatus("active")); // adds an entry to the
																					// userStatusMap
		userStatusMap.put("inactive", database.getUserStatusCountByStatus("inactive"));
		builder.withDetail("userStatus", userStatusMap);

		// New HashMap called userStausMap is created. This map is intended to store the
		// counts of user statuses (e.g., "active" and "inactive").
